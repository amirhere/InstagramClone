        ...
        <div class="row">
            ...
            <div class="col-8 offset-2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="caption" name="caption" type="text" class="form-control @error('caption') is-invalid @enderror" name="caption" value="{{ old('caption') }}"  autocomplete="caption" autofocus>
